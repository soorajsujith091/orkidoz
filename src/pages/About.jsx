  ...
  return (
    <main>
      <Helmet>
        ...
        <meta property="og:description" content="GOTS-certified organic cotton baby clothing for newborns. Born from love, made for little beginnings." />
      ...
      {/* ══════════════════════════════════════════════════════
          ...
          ══════════════════════════════════════════════════════ */}
      <section className="relative min-h-[75vh] lg:min-h-[88vh] flex items-center overflow-hidden bg-canvas" aria-label="About Hero">
